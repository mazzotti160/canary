...
-- -- MazOT CATEGORIA ~ MAZOT
{
    ...
    name = "MazOT",
    rookgaard = true,
    subclasses = { "Tibia Coins", "Drome Potions", "Custom", "Exaltation Forge", "Bags", "Buffs", "Utilitarios" },
},

-- Nova categoria para Rookgaard
{
    icons = { "Category_Bar_of_Gold.png" },  -- Ícone para a categoria Rookgaard
    name = "Tibia Coins",
    parent = "MazOT",
    rookgaard = true,
    state = GameStore.States.STATE_NONE,
	...
	-- TESTE DSTORAGE
        {              
            ...
            movable = true,       
            count = 25,
            description = "{info}25 Tibia coins to trade with other characters!",
...
-- START DROME
{
    icons = { "extension.png" },  -- Ícone para a categoria Rookgaard
    name = "Drome Potions",
    parent = "MazOT",
    rookgaard = false,
    state = GameStore.States.STATE_NONE,
    ...
    movable = true,
    count = 1,
    description = "Reset all of your cooldowns",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your critical skill chance by 5% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increase your stamina by one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your charm runes chance to active.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Double your loot for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Double your bestiary kills for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your fire defense by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your ice defense by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your earth defense by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your energy defense by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your holy defense by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your death defense by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your physical defense by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your fire damage by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your ice damage by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your earth damage by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your energy damage by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your holy damage by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your death damage by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},
{
    icons = { "Gold_Pouch.png" },
    ...
    movable = true,
    count = 1,
    description = "Increases your physical damage by 8% for one hour.",
    type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
},			
    },
},
...
--cupcakes
 ...
 {              
		...
		{			              
            ...
            movable = true,   			
            count = 1,
            description = "{info}Grants you 24 of your vocations skill per 1 hour. Mages = ml, EK = sword, club, axe, RP = distance.",
            type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        }, 	
			{			              
            icons = { "Gold_Pouch.png" },
...
--end cupcakes				
 ...
 {              
            icons = { "Gold_Pouch.png" },
            name = "Random Addon Doll",
            price = 20,                
            itemtype = 28897,   
            count = 1,
            description = "{info}Gives you a random outfit with both addons. Store outfits included. Mage Hat not included!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        }, 	
 {              
            icons = { "Gold_Pouch.png" },
            name = "Random Mount Doll",
            price = 20,                
            itemtype = 28895,   
            count = 1,
            description = "{info}Gives you a random mount, all store mounts are included.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        }, 		
 {              
            icons = { "Gold_Pouch.png" },
...

{
    ...
    offers = {	
		...
		{			              
            icons = { "Frags.png" },
            name = "Skull and Frags remover",
            price = 20,                
            itemtype = 44044,   
			movable = true,
            count = 1,
            description = "{info}Remove tanto seus frags, quanto seu red/blackskull.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        }, 		
		{			              
 ...
 {              
			...
			movable = true,			
            count = 1,
            description = "{info}Wear it in your arrow slot to boost your damage. 5% protection all, 10% critical hit chance!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },  
		 {              
            icons = { "Gold_Pouch.png" },
			...
			movable = true,			
            count = 1,
            description = "{info}Wear it in your arrow slot to boost your defense! 15% protection all!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },  		 	
		{              
...
-- BUFF POTS START --	
			{
				...
				name = "Potions Buff 1",
				price = 90,
				description = "{info}Enhance your potions heal for the first time!",				
				type = GameStore.OfferTypes.OFFER_TYPE_POT1,
			},	
			{
				icons = { "apot2.png" },
				name = "Potions Buff 2",
				price = 180,
				description = "{info}Enhance your potions heal for the second time!",				
				type = GameStore.OfferTypes.OFFER_TYPE_POT2,
			},
			{
				icons = { "apot3.png" },
				name = "Potions Buff 3",
				price = 270,
				description = "{info}Enhance your potions heal for the third time!",				
				type = GameStore.OfferTypes.OFFER_TYPE_POT3,
			},
			{
				icons = { "boost7.png" },
				name = "Boosted Regen 7 days",
				price = 25,
				description = "{info}Add an extra regeneration for 7 days! The final HP/MP regeneration value is directly impacted by each mount the player gets.",				
				type = GameStore.OfferTypes.OFFER_TYPE_REGEN7,
			},	
			{
				icons = { "boost30.png" },
				name = "Boosted Regen 30 days",
				price = 90,
				description = "{info}Add an extra regeneration for 30 days! The final HP/MP regeneration value is directly impacted by each mount the player gets.",			
				type = GameStore.OfferTypes.OFFER_TYPE_REGEN30,
			},					
    },
},
--end test category

-- Nova categoria para main
...
-- Extras
	{
		...
		name = "Items",
		rookgaard = false,
		subclasses = { "Amulets", "Soul", "Primal", "Sanguine", "Grand Sanguine", "Inferniarch I", "Inferniarch II", "Inferniarch III", "Inferniarch IV", "Falcon Cobra Lion" },
	},
-- amulets
{
    icons = { "amulets.png" },
    ...
    offers = {
        {
            ...
            movable = true,
            count = 1,
            description = "This amulet absorbs 3% of all physical damage and 20% of death damage.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            ...
            movable = true,
            count = 1,
            description = "This amulet absorbs 3% of all physical damage and 20% of energy energy.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            ...
            movable = true,
            count = 1,
            description = "This amulet absorbs 3% of all physical damage and 20% of fire damage.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            ...
            movable = true,
            count = 1,
            description = "This amulet absorbs 3% of all physical damage and 20% of holy damage.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            ...
            movable = true,
            count = 1,
            description = "This amulet absorbs 3% of all physical damage and 20% of ice damage.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            name = "Amulet of physical",
            price = 290,
            itemtype = 60006,
            movable = true,
            count = 1,
            description = "This amulet absorbs 23% of all physical damage.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            ...
            movable = true,
            count = 1,
            description = "This amulet absorbs 3% of all physical damage and 20% of earth damage.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
    },
},	
	-- Soul
	{
		...
		offers = {
			...
			},
			{
				...
				movable = true,
				count = 1,
				description = "pair of soulwalkers",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
			...
			},
			{
				...
				movable = true,
				count = 1,
				description = "pair of soulstalkers",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
...
-- Primal
{
	...
	offers = {
		...
		},
		{
			...
			movable = true,
			count = 1,
			description = "spiritthorn helmet",
			type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		},
		{
			icons = { "Gold_Pouch.png" },
			...
			movable = true,
			count = 1,
			description = "charged spiritthorn ring",
			type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		},
		{
			icons = { "Gold_Pouch.png" },
		...
		},
		{
			...
			movable = true,
			count = 1,
			description = "Charged Alicorn Ring",
			type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		},
		{
			icons = { "Gold_Pouch.png" },
			...
			movable = true,
			count = 1,
			description = "arcanomancer regalia",
			type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		},
		{
			icons = { "Gold_Pouch.png" },
			...
			movable = true,
			count = 1,
			description = "arcanomancer folio",
			type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		},
		{
			icons = { "Gold_Pouch.png" },
			...
			movable = true,
			count = 1,
			description = "charged arcanomancer sigil",
			type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		},
		{
			icons = { "Gold_Pouch.png" },
		...
		},
		{
			...
			movable = true,
			count = 1,
			description = "charged arboreal ring",
			type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		},
	},
},
...
-- Sanguine
	{
		...
		offers = {
			...
			},
			{
				...
				movable = true,
				count = 1,
				description = "Sanguine Battleaxe",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
		...
		offers = {
			{
				...
				movable = true,
				count = 1,
				description = "Grand Sanguine Rod",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Grand Sanguine Coil",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Grand Sanguine Crossbow",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Grand Sanguine Bow",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Grand Sanguine Battleaxe",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Grand Sanguine Bludgeon",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Grand Sanguine Razor",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Grand Sanguine Hatchet",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Grand Sanguine Cudgel",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Grand Sanguine Blade",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
		},
},
...
-- Soul
	{
		...
		offers = {
			{
				icons = { "inferniarch.png" },
				name = "Inferniarch Slayer",
				price = 490,
				itemtype = 49530,
				movable = true,
				count = 1,
				description = "Inferniarch Slayer",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Inferniarch Warhammer",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				...
				movable = true,
				count = 1,
				description = "Inferniarch Greataxe",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
			...
			},
			{
				...
				movable = true,
				count = 1,
				description = "Inferniarch Battleaxe",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
			...
			},
			{
				...
				movable = true,
				count = 1,
				description = "Inferniarch Arbalest",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
...
-- infearnich 2
	{
		...
		offers = {
			{
				icons = { "Gold_Pouch.png" },
				name = "Modified Inferniarch Slayer",
				price = 690,
				itemtype = 49879,
				movable = true,
				count = 1,
				description = "Modified Inferniarch Slayer",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Modified Inferniarch Warhammer",
				price = 690,
				itemtype = 49873,
				movable = true,
				count = 1,
				description = "Modified Inferniarch Warhammer",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Modified Inferniarch Greataxe",
				price = 690,
				itemtype = 49867,
				movable = true,
				count = 1,
				description = "Modified Inferniarch Greataxe",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Modified Inferniarch Blade",
				price = 690,
				itemtype = 49876,
				movable = true,
				count = 1,
				description = "Modified Inferniarch Blade",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Modified Inferniarch Flail",
				price = 690,
				itemtype = 49870,
				movable = true,
				count = 1,
				description = "Modified Inferniarch Flail",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Modified Inferniarch Battleaxe",
				price = 690,
				itemtype = 49864,
				movable = true,
				count = 1,
				description = "Modified Inferniarch Battleaxe",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Modified Inferniarch Bow",
				price = 690,
				itemtype = 49858,
				movable = true,
				count = 1,
				description = "Modified Inferniarch Bow",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Modified Inferniarch Arbalest",
				price = 690,
				itemtype = 49861,
				movable = true,
				count = 1,
				description = "Modified Inferniarch Arbalest",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Modified Inferniarch Wand",
				price = 690,
				itemtype = 49882,
				movable = true,
				count = 1,
				description = "Modified Inferniarch Wand",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Modified Inferniarch Rod",
				price = 690,
				itemtype = 49885,
				movable = true,
				count = 1,
				description = "Modified Inferniarch Rod",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
		},
},
...
-- Soul
	{
		icons = { "inferniarch3.png" },
		name = "Inferniarch III",
		parent = "Items",
		rookgaard = false,
		state = GameStore.States.STATE_NONE,
		offers = {
			{
				icons = { "Gold_Pouch.png" },
				name = "Enhanced Inferniarch Slayer",
				price = 890,
				itemtype = 49880,
				movable = true,
				count = 1,
				description = "Enhanced Inferniarch Slayer",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Enhanced Inferniarch Warhammer",
				price = 890,
				itemtype = 49874,
				movable = true,
				count = 1,
				description = "Enhanced Inferniarch Warhammer",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Enhanced Inferniarch Greataxe",
				price = 890,
				itemtype = 49868,
				movable = true,
				count = 1,
				description = "Enhanced Inferniarch Greataxe",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Enhanced Inferniarch Blade",
				price = 890,
				itemtype = 49877,
				movable = true,
				count = 1,
				description = "Enhanced Inferniarch Blade",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Enhanced Inferniarch Flail",
				price = 890,
				itemtype = 49871,
				movable = true,
				count = 1,
				description = "Enhanced Inferniarch Flail",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Enhanced Inferniarch Battleaxe",
				price = 890,
				itemtype = 49865,
				movable = true,
				count = 1,
				description = "Enhanced Inferniarch Battleaxe",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Enhanced Inferniarch Bow",
				price = 890,
				itemtype = 49859,
				movable = true,
				count = 1,
				description = "Enhanced Inferniarch Bow",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Enhanced Inferniarch Arbalest",
				price = 890,
				itemtype = 49862,
				movable = true,
				count = 1,
				description = "Enhanced Inferniarch Arbalest",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Enhanced Inferniarch Wand",
				price = 890,
				itemtype = 49883,
				movable = true,
				count = 1,
				description = "Enhanced Inferniarch Wand",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Enhanced Inferniarch Rod",
				price = 890,
				itemtype = 49886,
				movable = true,
				count = 1,
				description = "Enhanced Inferniarch Rod",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
		},
},
...
-- Soul
{
    ...
    offers = {
        {
            icons = { "Gold_Pouch.png" },
            name = "Supreme Inferniarch Slayer",
            price = 1090,
            itemtype = 49881,
            movable = true,
            count = 1,
            description = "Supreme Inferniarch Slayer",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            name = "Supreme Inferniarch Warhammer",
            price = 1090,
            itemtype = 49875,
            movable = true,
            count = 1,
            description = "Supreme Inferniarch Warhammer",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            name = "Supreme Inferniarch Greataxe",
            price = 1090,
            itemtype = 49869,
            movable = true,
            count = 1,
            description = "Supreme Inferniarch Greataxe",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            name = "Supreme Inferniarch Blade",
            price = 1090,
            itemtype = 49878,
            movable = true,
            count = 1,
            description = "Supreme Inferniarch Blade",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            name = "Supreme Inferniarch Flail",
            price = 1090,
            itemtype = 49872,
            movable = true,
            count = 1,
            description = "Supreme Inferniarch Flail",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            name = "Supreme Inferniarch Battleaxe",
            price = 1090,
            itemtype = 49866,
            movable = true,
            count = 1,
            description = "Supreme Inferniarch Battleaxe",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            name = "Supreme Inferniarch Bow",
            price = 1090,
            itemtype = 49860,
            movable = true,
            count = 1,
            description = "Supreme Inferniarch Bow",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            name = "Supreme Inferniarch Arbalest",
            price = 1090,
            itemtype = 49863,
            movable = true,
            count = 1,
            description = "Supreme Inferniarch Arbalest",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            name = "Supreme Inferniarch Wand",
            price = 1090,
            itemtype = 49884,
            movable = true,
            count = 1,
            description = "Supreme Inferniarch Wand",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Gold_Pouch.png" },
            name = "Supreme Inferniarch Rod",
            price = 1090,
            itemtype = 49887,
            movable = true,
            count = 1,
            description = "Supreme Inferniarch Rod",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
    },
},
...
-- Soul
	{
		...
		offers = {
			...
			},
			{
				...
				movable = true,
				count = 1,
				description = "Lion longsword",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
				name = "Lion spangehelmet",
				price = 55,
				itemtype = 34156,
				movable = true,
				count = 1,
				description = "Lion spangehelmet",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
			...
			},
			{
				...
				movable = true,
				count = 1,
				description = "Dawnfire Pantaloons",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Gold_Pouch.png" },
