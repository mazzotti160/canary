...
{ name = "minor crystalline token", chance = 1500, maxCount = 2 },
	{ id = 3400, chance = 150, unique = false }, -- dragon scale helmet
	{ id = 24955, chance = 500, unique = false }, -- part of a rune
	{ id = 11692, chance = 300, unique = false }, -- snake god's sceptre
}
