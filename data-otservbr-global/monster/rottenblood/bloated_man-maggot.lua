...
monster.attacks = {
	...
	{ name = "combat", interval = 2500, chance = 35, type = COMBAT_PHYSICALDAMAGE, minDamage = -700, maxDamage = -850, radius = 5, effect = CONST_ME_GHOSTLY_BITE, target = true },
	{ name = "combat", interval = 2500, chance = 30, type = COMBAT_EARTHDAMAGE, minDamage = -700, maxDamage = -850, radius = 5, effect = CONST_ME_BIGPLANTS, target = false },
	...
	{ name = "largefirering", interval = 2500, chance = 25, minDamage = -700, maxDamage = -900, target = false },
}
