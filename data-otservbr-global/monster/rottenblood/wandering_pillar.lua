...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -700, maxDamage = -825, length = 8, spread = 3, effect = CONST_ME_BLUE_ENERGY_SPARK, target = false },
	{ name = "combat", intervall = 2000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -550, maxDamage = -750, radius = 5, effect = CONST_ME_PINK_BEAM, target = false },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -700, maxDamage = -850, radius = 5, effect = CONST_ME_HITBYFIRE, target = true },
	{ name = "largeholyring", interval = 2000, chance = 25, minDamage = -450, maxDamage = -625 },
}
