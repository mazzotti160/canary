...
{ name = "minor crystalline token", chance = 1500, maxCount = 2 },
	...
	{ name = "dauntless dragon scale armor", chance = 1200, maxCount = 1 },
	{ name = "herald's insignia", chance = 400, maxCount = 1 },
	{ name = "herald's wings", chance = 400, maxCount = 1 },
	{ name = "mystical dragon robe", chance = 1200, maxCount = 1 },
	{ name = "unerring dragon scale armor", chance = 1200, maxCount = 1 },
}
