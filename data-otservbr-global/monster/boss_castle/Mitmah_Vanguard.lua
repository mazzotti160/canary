...
{ name = "minor crystalline token", chance = 1500, maxCount = 2 },
	...
	{ name = "stoic iks boots", chance = 1200, maxCount = 1 },
	{ name = "stoic iks casque", chance = 1200, maxCount = 1 },
	{ name = "stoic iks chestplate", chance = 1200, maxCount = 1 },
	{ name = "stoic iks culet", chance = 1200, maxCount = 1 },
	{ name = "stoic iks faulds", chance = 1200, maxCount = 1 },
	{ name = "stoic iks headpiece", chance = 1200, maxCount = 1 },
	{ name = "stoic iks sandals", chance = 1200, maxCount = 1 },
	{ name = "stoic iks cuirass", chance = 1200, maxCount = 1 },
}
