...
monster.loot = {
{ id = 14758, chance = 500 }, -- arena scroll
{ id = 28897, chance = 1000 }, -- random addon doll
{ id = 43895, chance = 500 }, -- Bag you covet
{ name = "bag you desire", chance = 850 },
{ name = "primal bag", chance = 850 },	
	...
	{ id = 19082, chance = 1000 }, -- roletinha	
	--skulls
	{id = 37341, chance = 25, count = 1},
	{id = 37340, chance = 25, count = 1},
	{id = 37339, chance = 25, count = 1},
	{id = 37338, chance = 25, count = 1},
	{id = 37337, chance = 25, count = 1},
	{id = 37335, chance = 25, count = 1},
	--druid
	    {id = 44759, chance = 25, count = 1},  -- giant beaver
        {id = 12809, chance = 25, count = 1},  -- epic wisdom
        {id = 34266, chance = 25, count = 1},  -- tibiapedia
	--sorc
        {id = 22153, chance = 25, count = 1},  -- dark wizard crown
        {id = 44055, chance = 25, count = 1},  -- dragon shield verde
        {id = 44056, chance = 25, count = 1},  -- dragon verde doll
			-- pala
        {id = 16262, chance = 25, count = 1},  -- dragon eye
        {id = 39761, chance = 25, count = 1},  -- gods rp twilight doll
        {id = 35909, chance = 25, count = 1},  -- chaos critical dice
			--ek
        {id = 39759, chance = 25, count = 1},  -- golden gods twilight doll
        {id = 22889, chance = 25, count = 1},  -- shield of destiny
        {id = 25982, chance = 25, count = 1},  -- mathmaster shield	
-- set
        {id = 3423, chance = 25, count = 1}, -- blessed shield
		{id = 3246, chance = 25, count = 1}, -- boots of waterwalking
		{id = 3363, chance = 25, count = 1}, -- dragon scale legs
		{id = 3402, chance = 25, count = 1}, -- native armor
		{id = 3365, chance = 25, count = 1}, -- golden helmet			
}
