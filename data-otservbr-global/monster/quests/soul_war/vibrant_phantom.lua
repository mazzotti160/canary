...
{ name = "extended energy chain", interval = 2000, chance = 15, minDamage = -375, maxDamage = -450, range = 7 },
{ name = "combat", interval = 3000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -600, maxDamage = -900, range = 7, radius = 4, effect = CONST_ME_ENERGYAREA, target = false },
{ name = "combat", interval = 3000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -750, maxDamage = -900, range = 7, radius = 4, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = true },
{ name = "combat", interval = 2000, chance = 25, type = COMBAT_HOLYDAMAGE, minDamage = -788, maxDamage = -975, range = 7, shootEffect = CONST_ANI_SMALLHOLY, effect = CONST_ME_HOLYDAMAGE, target = true },
{ name = "extended holy chain", interval = 2000, chance = 15, minDamage = -773, maxDamage = -938, range = 7 },
}
