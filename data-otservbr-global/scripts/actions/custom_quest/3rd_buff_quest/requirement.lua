...
function checkPremium.onStepIn(creature, item, position, fromPosition)
    ...
    if player:getStorageValue(4535656514) >= 2 then
	    ...
	    player:say("You need to finish 2st buff pot quest!", TALKTYPE_MONSTER_SAY, false, player, fromPosition)
...
checkPremium:position({ x = 32372, y = 32233, z = 4 }) --(32372, 32233, 4)
