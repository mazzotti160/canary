...
function craftGrandSanguineCrossbow.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    local mainItemId = 49526 -- GS wand
    local mainItemCount = 1

    -- Recompensa
    local reward = {
        itemId = 49873 -- ID da Grand Sanguine Crossbow
    }

    -- Itens necessários (além do item principal)
    local requiredItems = {
        {id = 16206, count = 60}, -- abyssador lash
        {id = 16136, count = 60}, -- deathstrike snippet
        {id = 16205, count = 60}, -- gnomevil hat
        {id = 27621, count = 55}, -- huge shell
        {id = 27627, count = 55}, -- huge spiky snail shell
        {id = 27619, count = 55}, -- giant tentacle
        {id = 36796, count = 23}, -- brainstealer brainwave
        {id = 36795, count = 23}, -- brainstealer brain
        {id = 36794, count = 23}, -- brainstealer tissue
        {id = 39040, count = 14},    -- fiery tear
        {id = 39543, count = 14},    -- smoldering eye
        {id = 33928, count = 9},    -- megalomania essence
        {id = 33925, count = 9},    -- megalomania skull
        {id = 43968, count = 8},    -- bakragore amalgamation
        {id = 36793, count = 188},    -- abomination tongue
        {id = 22723, count = 230}    --titanium token
    }
...
craftGrandSanguineCrossbow:position({ x = 32342, y = 32181, z = 5 }) 
