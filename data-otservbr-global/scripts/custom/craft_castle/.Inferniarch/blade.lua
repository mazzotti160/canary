...
function craftGrandSanguineCrossbow.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    local mainItemId = 43865 -- GS wand
    local mainItemCount = 1

    -- Recompensa
    local reward = {
        itemId = 49527 -- ID da Grand Sanguine Crossbow
    }

    -- Itens necessários (além do item principal)
    local requiredItems = {
        {id = 16206, count = 45}, -- abyssador lash
        {id = 16136, count = 45}, -- deathstrike snippet
        {id = 16205, count = 45}, -- gnomevil hat
        {id = 27621, count = 37}, -- huge shell
        {id = 27627, count = 37}, -- huge spiky snail shell
        {id = 27619, count = 37}, -- giant tentacle
        {id = 36796, count = 15}, -- brainstealer brainwave
        {id = 36795, count = 15}, -- brainstealer brain
        {id = 36794, count = 15}, -- brainstealer tissue
        {id = 39040, count = 9},    -- fiery tear
        {id = 39543, count = 9},    -- smoldering eye
        {id = 33928, count = 6},    -- megalomania essence
        {id = 33925, count = 6},    -- megalomania skull
        {id = 43968, count = 5},    -- bakragore amalgamation
        {id = 36793, count = 125},    -- abomination tongue
        {id = 22723, count = 150}    --titanium token
    }
...
craftGrandSanguineCrossbow:position({ x = 32342, y = 32185, z = 6 })
