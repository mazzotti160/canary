...
function craftGrandSanguineCrossbow.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    local mainItemId = 49865 -- GS wand
    local mainItemCount = 1

    -- Recompensa
    local reward = {
        itemId = 49866 -- ID da Grand Sanguine Crossbow
    }

    -- Itens necessários (além do item principal)
    local requiredItems = {
        {id = 16206, count = 145}, -- abyssador lash
        {id = 16136, count = 145}, -- deathstrike snippet
        {id = 16205, count = 145}, -- gnomevil hat
        {id = 27621, count = 121}, -- huge shell
        {id = 27627, count = 121}, -- huge spiky snail shell
        {id = 27619, count = 121}, -- giant tentacle
        {id = 36796, count = 51}, -- brainstealer brainwave
        {id = 36795, count = 51}, -- brainstealer brain
        {id = 36794, count = 51}, -- brainstealer tissue
        {id = 39040, count = 32},    -- fiery tear
        {id = 39543, count = 32},    -- smoldering eye
        {id = 33928, count = 21},    -- megalomania essence
        {id = 33925, count = 21},    -- megalomania skull
        {id = 43968, count = 18},    -- bakragore amalgamation
        {id = 36793, count = 282},    -- abomination tongue
        {id = 22723, count = 515}    --titanium token
    }
...
craftGrandSanguineCrossbow:position({ x = 32342, y = 32187, z = 3 })
