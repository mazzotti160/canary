...
--start vendas
    { itemName = "abyssador lash", clientId = 16206, buy = 1, count = 1 },
    { itemName = "deathstrike snippet", clientId = 16136, buy = 1, count = 1 },
    { itemName = "gnomevil hat", clientId = 16205, buy = 1, count = 1 },
    { itemName = "huge shell", clientId = 27621, buy = 1, count = 1 },
    { itemName = "huge spiky snail shell", clientId = 27627, buy = 1, count = 1 },
    { itemName = "giant tentacle", clientId = 27619, buy = 1, count = 1 },
    { itemName = "brainstealer brainwave", clientId = 36796, buy = 1, count = 1 },
    { itemName = "brainstealer brain", clientId = 36795, buy = 1, count = 1 },
    { itemName = "brainstealer tissue", clientId = 36794, buy = 1, count = 1 },
    { itemName = "fiery tear", clientId = 39040, buy = 1, count = 1 },
    { itemName = "smoldering eye", clientId = 39543, buy = 1, count = 1 },
    { itemName = "megalomania essence", clientId = 33928, buy = 1, count = 1 },
    { itemName = "megalomania skull", clientId = 33925, buy = 1, count = 1 },
    { itemName = "bakragore amalgamation", clientId = 43968, buy = 1, count = 1 },
    { itemName = "abomination tongue", clientId = 36793, buy = 1, count = 1 },
    { itemName = "titanium token", clientId = 22723, buy = 1, count = 1 },
